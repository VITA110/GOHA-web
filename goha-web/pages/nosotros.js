...
const contenidoSecciones = [
  {
    ...
    texto: "Hace más de 35 años, International Operating Solutions inició operaciones como proveedor e importador para la industria Chihuahuense, posicionándose rápidamente como un consultor estratégico en soluciones tecnológicas. A lo largo de su evolución, la empresa consolidó un portafolio especializado en Tecnologías de la Información, integrando soluciones como MRO, código de barras, videocolaboración, redes y seguridad, siempre alineadas a las necesidades de sus principales verticales de negocio. En 2015, la organización inició una transformación clave con cambios en sus razones sociales y para 2018, adoptó su estructura operativa actual, reestructurando procesos y soluciones para ofrecer un portafolio más robusto y eficiente. Como parte de su estrategia de crecimiento, en 2022 se integró GOHA Networks como filial de International Operating Solutions, incorporando servicios técnicos especializados. Esta integración reafirma el compromiso del grupo por ofrecer soluciones tecnológicas integrales, innovadoras y de alto impacto. Hoy, International Operating Solutions continúa evolucionando, respaldada por décadas de experiencia, un equipo altamente especializado y una visión clara de innovación, excelencia operativa y generación de valor sostenible para sus clientes.",
